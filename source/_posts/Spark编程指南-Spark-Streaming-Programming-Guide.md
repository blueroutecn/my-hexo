...
![/img/Spark编程指南-Spark-Streaming-Programming-Guide/streaming-dstream](streaming-dstream)

任何应用在DStream上的操作都会转化成对内部RDD的操作。例如，之前的例子中，将文本行的输入流切分为单词，*flatMap*操作被应用在了*lines*DStream的每个RDD中，来生成*words*DStream的RDD。如下图所示。

![/img/Spark编程指南-Spark-Streaming-Programming-Guide/streaming-dstream-ops](streaming-dstream-ops)
...
![/img/Spark编程指南-Spark-Streaming-Programming-Guide/streaming-dstream-window](streaming-dstream-window.png)
